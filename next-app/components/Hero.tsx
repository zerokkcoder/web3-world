        ...
        <header className="px-6 pt-12">
            <div className="max-w-4xl mx-auto flex gap-16 items-center flex-col-reverse md:flex-row">
                <div>
                    ...
                    <a href="/work" className="bg-black text-white hover:bg-gray-500 dark:bg-white dark:text-black hover:dark:bg-gray-500 px-6 py-3 text-lg rounded">Check my work</a>
                </div>
                <span>
